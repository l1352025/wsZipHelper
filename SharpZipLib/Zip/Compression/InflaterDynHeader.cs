...
namespace ICSharpCode.SharpZipLib.Zip.Compression
{
	class InflaterDynHeader
	{
		...
		public InflaterHuffmanTree LiteralLengthTree
			//Test_Code => litLenTree ?? throw new StreamDecodingException("Header properties were accessed before header had been successfully read");
        {
            get
            {
                if (litLenTree == null)
		...
		public InflaterHuffmanTree DistanceTree
			//Test_Code => distTree ?? throw new StreamDecodingException("Header properties were accessed before header had been successfully read");
        {
            get{
                if(distTree == null)
                {
